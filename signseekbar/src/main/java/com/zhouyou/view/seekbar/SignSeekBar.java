...
public class SignSeekBar extends View {
    ...
    public SignSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTrackColor = a.getColor(R.styleable.SignSeekBar_ssb_track_color, mSecondTrackColor & 0xffffff ^ (125 << 24));
    ...
    private void drawThumbText(Canvas canvas, float yTop) {
        ...
        if (isFloatType || (isShowProgressInFloat && mSectionTextPosition == TextPosition.BOTTOM_SIDES &&
            ...
            if (mValueFormatListener != null) value = mValueFormatListener.format(this, progress);
    ...
    private void createValueTextLayout() {
        ...
        if (mValueFormatListener == null) {
            ...
            value = mValueFormatListener.format(this, Float.parseFloat(value));
        }
    ...
    public void setColor(int trackColor, int secondTrackColor) {
        mSecondTrackColor = secondTrackColor;
        mThumbColor = secondTrackColor;
        mTrackColor = trackColor == 0 ? secondTrackColor & 0xffffff ^ (125 << 24) : trackColor;
        mSignColor = secondTrackColor;
        invalidate();
    }
    ...
    public interface OnValueFormatListener {
        String format(SignSeekBar signSeekBar, float progress);
    }
}
