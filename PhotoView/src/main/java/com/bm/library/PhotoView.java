...
public class PhotoView extends ImageView {
    ...
    private final static int ANIMA_DURING = 500;
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    public Info getInfo() {
        ...
        int[] p = new int[2];
        getLocation(this, p);
//        Log.e("position1", p[0] + "    " + p[1]);
//        Log.e("imgRect", mImgRect.top + "   " + mImgRect.bottom);
//        mImgRect.bottom -= SystemBarHeight;
        rect.set(p[0] + mImgRect.left, p[1] + mImgRect.top, p[0] + mImgRect.right, p[1] + mImgRect.bottom);
        //rect.set(p[0] + mImgRect.left, p[1], p[0] + mImgRect.right, p[1]);
        //Log.e("position2", p[0] + "    " + p[1]);
    ...
    public static Info getImageViewInfo(ImageView imgView) {
        ...
        return new Info(rect, widgetRect, widgetRect, baseRect, screenCenter, 1, 0, imgView.getScaleType());
    }
